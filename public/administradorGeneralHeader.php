    ...
    <div class="container">
        ...
        <button class="nav-toggle" aria-label="Abrir menú">
            ...
            <ul class="nav-menu">
                ...
                <li><a class="nav-menu-link nav-link" href="?controlador=Index&accion=mostrarVerUsuario">Usuarios</a></li>
                <li><a class="nav-menu-link nav-link" href="?controlador=Index&accion=mostrarPlantas">Plantas</a></li>
                <li><a class="nav-menu-link nav-link" href="?controlador=Index&accion=mostrarEspecimenGenero">Buscar especimen genero</a></li>
                <li><a class="nav-menu-link nav-link" href="?controlador=Index&accion=mostrarEspecimenEspecie">Buscar especimen especie</a></li>
                <li><a class="nav-menu-link nav-link" href="?controlador=Index&accion=mostrarRegistrarUsuario">Agregar Usuario</a></li>
